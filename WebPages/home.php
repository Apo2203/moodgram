                        ...
                        <div class="container Cardsize" id="pos'.$data['id_post'].'" style="margin-bottom: 7rem;">
                            ...
                            <div class="row" style="margin: 0;">
                                <div class="col col-style-sx" data-bss-hover-animate="pulse">
                                    ...
                                    <img class="img-fluid image-style" src="../assets/img/generatedImage/'.$data['image_ref_user1'].'" alt="image generated by user">
                                </div>
                                <div class="col col-style-dx" data-bss-hover-animate="pulse">
                                    ...
                                    <img class="img-fluid image-style" src="../assets/img/generatedImage/'.$data['image_ref_user2'].'" alt="image generated by user">
                                </div>
                            </div>
                        </div>
                    ');
            ...
            <div class="container NoMorePostSizeForBigScreen" style="margin-bottom: 7rem;">
                <div class="row" data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true" style="margin: 0;box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;margin-bottom: 2rem;padding: 1rem;border-radius: 3rem;background: #549ad4;">
                    <div class="col text-center">
                        <p style="color: rgb(0,0,0);text-align: center;font-size: 2rem;font-family: Aboreto, serif;">It's all for now, no more post to show you</p><img src="../assets/img/allPostSeen.png?h=e404b28546662f09501ec78b4461766c" style="width: 30%; " lt="It's all, no more post to show you">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <a href="Profile.php?id_user='.$id.'/"><img src="../assets/img/profilePictureImage/'.$proPic.'" alt="Profile picture" style="width: 3rem; border-radius: 3rem;" lt="Profile picture of user"></a>
